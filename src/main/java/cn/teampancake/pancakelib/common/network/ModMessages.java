package cn.teampancake.pancakelib.common.network;


import cn.teampancake.pancakelib.PancakeLib;
import cn.teampancake.pancakelib.common.network.message.PlayerEquipmentSetSyncS2CPacket;
import cn.teampancake.pancakelib.common.network.message.PlayerModifierSyncS2CPacket;
...
public class ModMessages {
    ...
    public static void register(){
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(PancakeLib.asResource("messages"))
