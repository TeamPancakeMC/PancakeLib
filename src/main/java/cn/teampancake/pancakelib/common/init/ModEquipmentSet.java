...
public class ModEquipmentSet {
    ...
    public static final ResourceKey<Registry<IEquipmentSet>> EQUIPMENT_SET_KEY = PancakeLib.asResourceKey("equipment_set");
    public static final DeferredRegister<IEquipmentSet> EQUIPMENT_SET = DeferredRegister.create(EQUIPMENT_SET_KEY, PancakeLib.MOD_ID);
